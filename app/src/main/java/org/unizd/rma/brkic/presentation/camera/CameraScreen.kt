...
import org.unizd.rma.brkic.presentation.skincareItem.detail.ProductDetailViewModel
import java.io.File
...
fun CameraScreen(
    ...
    Scaffold (
        topBar = {
            TopAppBar(
                title = { Text("Take a photo of the product") },
                navigationIcon = {
        ...
        Column (
            ...
            Button(
                ...
                Icon(Icons.Filled.PhotoCamera, "Take a photo")
            }
